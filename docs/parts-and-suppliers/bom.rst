...
.. note::
  You have different possibilities for creating your RoboRacer car. We are focusing on a hardware setup that is based on the  `Traxxas Slash 4x4 Premium <https://traxxas.com/6804r-110-slash-4x4-platinum-short-course-truck>`_ Chassis and the `NVIDIA Jetson Xavier NX <https://developer.nvidia.com/embedded/jetson-xavier-nx-devkit>`_. The hardware setup based on the NVIDIA Jetson TX2 and Traxxas Ford Focus chassis is deprecated.
